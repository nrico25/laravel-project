<nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <x-nav-link-mobile href= home :active="request() ->is('home')">Home</x-nav-link>
        <x-nav-link-mobile href=contact :active="request() ->is('contact')">Contact</x-nav-link>
        <x-nav-link-mobile href=student :active="request() ->is('student')">Student</x-nav-link>
        <x-nav-link-mobile href=grade :active="request() ->is('grade')">Grade</x-nav-link>
